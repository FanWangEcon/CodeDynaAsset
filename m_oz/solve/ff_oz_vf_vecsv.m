...
function result_map = ff_oz_vf_vecsv(varargin)
%% FF_OZ_VF_VEC solve infinite horizon exo shock + endo asset problem
% Similar to
% <https://fanwangecon.github.io/CodeDynaAsset/m_az/solve/html/ff_az_vf_vecsv.html
% ff_az_vf_vecsv> except that rather than savings/borrow, cash-on-hand is the
...
% * <https://github.com/FanWangEcon/CodeDynaAsset/blob/master/m_az/solvepost/ff_oz_vf_post.m ff_oz_vf_post>
%
...
while bl_vfi_continue
    ...
    % Only this segment of code differs between ff_oz_vf and ff_oz_vf_vec
    ...
    for it_z_i = 1:length(ar_z)
        ...
        if (it_iter == 1)
            ...
            % Consumption
            mt_c = f_cons(mt_coh(:, it_z_i)', ar_a');
