...
function [param_map, support_map] = ffs_oz_set_default_param(varargin)
%% FFS_OZ_SET_DEFAULT_PARAM setting model default parameters
% Same as
% <https://fanwangecon.github.io/CodeDynaAsset/m_az/paramfunc/html/ffs_az_set_default_param.html
% ffs_az_set_default_param>, cash-on-hand solution does not introduce
