...
function [result_map] = ff_oz_vf_post(varargin)
%% FF_OZ_VF_POST post ff_oz_vf graphs, tables, mats.
% similar to
% <https://fanwangecon.github.io/CodeDynaAsset/m_az/solvepost/html/ff_az_vf_post.html
% ff_az_vf_post> except that rather than savings/borrow, cash-on-hand is the
...
% @include
%
% * <https://github.com/FanWangEcon/CodeDynaAsset/blob/master/m_az/solvepost/ff_oz_vf_post_graph.m ff_oz_vf_post_graph>
...
% equation shere differ from ff_az_vf_post
