...
function [armt_map, func_map] = ffs_ipwkbz_get_funcgrid_tight(varargin)
%% FFS_ipwkbz_GET_FUNCGRID_TIGHT a special file
% File created when I thought I had to drop some of the choice grids because at
% those points there were no valid borrowing choices. But this should not be
% needed with the borrowing default no default code structure.
%
