...
3. *abz* model compare (a) save vs (b) borrow (no default) vs (c) borrow (default possible but do not) (d) borrow (default possible and do default) (e) borrow (default possible and always default)
