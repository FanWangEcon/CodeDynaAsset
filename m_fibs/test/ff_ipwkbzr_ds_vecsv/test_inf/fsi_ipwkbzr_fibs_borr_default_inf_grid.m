...
cl_st_param_keys_grp1 = {'fl_z_r_infbr_poiss_mean', 'fl_z_r_infbr_max'};
cl_st_param_keys_grp2 = {'fl_z_r_infbr_min', 'fl_z_r_infbr_max'};

% Generate Arrays of Parameter Values to Loop Over
it_simu_vec_len = 15;
param_tstar_map_local = containers.Map('KeyType','char', 'ValueType','any');
param_tstar_map_local('fl_z_r_infbr_poiss_mean') = linspace(2, 10, it_simu_vec_len);
param_tstar_map_local('fl_z_r_infbr_max') = linspace(0.065, 0.30, it_simu_vec_len);
