...
% How borrowing and savings interest rates jointly impact
cl_st_param_keys_grp1 = {'fl_r_fsv', 'fl_r_fbr'};
% How borrowing interest rate and borrowing formal block jointly impact
cl_st_param_keys_grp2 = {'fl_r_fbr', 'fl_forbrblk_gap'};

% Generate Arrays of Parameter Values to Loop Over
it_simu_vec_len = 15;
param_tstar_map_local = containers.Map('KeyType','char', 'ValueType','any');
param_tstar_map_local('fl_r_fsv') = linspace(0.00, 0.05, it_simu_vec_len);
param_tstar_map_local('fl_r_fbr') = linspace(0.03, 0.08, it_simu_vec_len);
