%% Test Shock Persistence and Variance (Save + Borr + For + Inf Distribution)
% *back to <https://fanwangecon.github.io Fan>'s
% <https://fanwangecon.github.io/CodeDynaAsset/ Dynamic Assets Repository>
% Table of Content.*
%
% Testing the
% <https://fanwangecon.github.io/CodeDynaAsset/m_abz_fibs/solve/html/ff_az_ds.html
% ff_az_ds> program for solving the savings only dynamic
% programming problem.
%
% defaults in ffs_abz_fibs_set_default_param.m are:
%
...
% @seealso
%
% * _PREFERENCE_: savings only quick vs benchmark testing: <https://fanwangecon.github.io/CodeDynaAsset/m_abz_fibs/test/ff_az_ds/test_pref/html/fsi_abz_fibs_ds_pref.html fsi_abz_fibs_ds_pref>
% * _SHOCK_: savings only asset grid count testing: <https://fanwangecon.github.io/CodeDynaAsset/m_abz_fibs/test/ff_az_ds/test_shock/html/fsi_abz_fibs_ds_shock.html fsi_abz_fibs_ds_shock>
...
for fl_z_sig = ar_fl_z_sig
    ...
    % Call Default Parameters <https://fanwangecon.github.io/CodeDynaAsset/m_abz_fibs/paramfunc/html/ffs_abz_fibs_set_default_param.html ffs_abz_fibs_set_default_param>
    ...
    % Call Grid Generator <https://fanwangecon.github.io/CodeDynaAsset/m_abz_fibs/paramfunc/html/ffs_abz_fibs_get_funcgrid.html ffs_abz_fibs_get_funcgrid>
    [armt_map, func_map] = ffs_abz_fibs_get_funcgrid(param_map, support_map, bl_input_override);

    % Call Dynamic Programming Problem <https://fanwangecon.github.io/CodeDynaAsset/m_abz_fibs/solve/html/ff_abz_fibs_vf_vecsv.html ff_abz_fibs_vf_vecsv>
