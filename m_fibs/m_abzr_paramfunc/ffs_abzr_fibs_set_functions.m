...
function [f_util_log, f_util_crra, f_util_standin, f_inc, f_coh, f_cons_coh_fbis, f_cons_coh_save, f_bprime] = ...
    ffs_abzr_fibs_set_functions(varargin)
%% FFS_ABZ_SET_FIBS_FUNCTIONS setting model functions
% Define functions for the abzr problem with formal and informal borrowing
% and savings. See here:
% <https://fanwangecon.github.io/CodeDynaAsset/m_abzr/paramfunc/html/ffs_abzr_set_functions.html
% ffs_abzr_set_functions> for *abzr* function settings without without formal
% and informal considerations. Note, param_map('bl_b_is_principle') =
% false for _abzr_fibs_.
%
...
%        ffs_abzr_set_functions(fl_crra, fl_c_min, fl_r_fbr, fl_r_fsv, fl_w);
%
