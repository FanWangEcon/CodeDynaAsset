...
%
% # quick: fast run
% # benchmark: default as set in <https://fanwangecon.github.io/CodeDynaAsset/m_abz/paramfunc/html/ffs_abz_fibs_set_default_param.html ffs_abz_fibs_set_default_param>
