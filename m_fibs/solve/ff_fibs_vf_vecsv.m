...
function result_map = ff_fibs_vf_vecsv(varargin)
%% FF_FIBS_VF_VECSV solve infinite horizon exo shock + endo asset problem
...
% @include
%
% * <https://github.com/FanWangEcon/CodeDynaAsset/blob/master/m_fibs/paramfunc/ff_fibs_evf.m ff_fibs_evf>
% * <https://github.com/FanWangEcon/CodeDynaAsset/blob/master/m_fibs/paramfunc/ffs_fibs_set_default_param.m ffs_fibs_set_default_param>
% * <https://github.com/FanWangEcon/CodeDynaAsset/blob/master/m_fibs/paramfunc/ffs_fibs_get_funcgrid.m ffs_fibs_get_funcgrid>
...
% parameters can be set inside ffs_fibs_set_default_param or updated here
...
[armt_map, func_map] = ffs_fibs_get_funcgrid(param_map, support_map, bl_input_override); % 1 for override
...
while bl_vfi_continue
    ...
    % ffs_fibs_get_funcgrid.m. Generate interpolant based on that, Then
    ...
    [mt_ev_condi_z_max, ~, mt_ev_condi_z_max_kp, ~] = ...
        ff_fibs_evf(mt_val_wkb_interpolated, param_map, support_map, armt_map, bl_input_override);
    ...
    for it_z_i = 1:length(ar_z)
        ...
        % on which we solve the 2nd stage problem in ff_fibs_evf.m. Here for
        ...
        % min percent is not 0 in ffs_fibs_get_funcgrid.m)
