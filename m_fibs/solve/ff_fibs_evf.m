...
function [mt_ev_condi_z_max, mt_ev_condi_z_max_idx, mt_ev_condi_z_max_kp, mt_ev_condi_z_max_bp] = ff_fibs_evf(varargin)
%% FF_FIBS_EVF solves the k' vs b' problem given aggregate savings
...
% what we do in the
% <https://fanwangecon.github.io/CodeDynaAsset/m_fibs/paramfunc/html/ffs_fibs_set_functions.html
% ffs_fibs_set_functions> code where we loop over current z, and for each
