...
function [param_map, support_map] = ffs_fibs_set_default_param(varargin)
...
% the addition here to solve formal and informal problem, second stage
% interpolation grid for today's coh, so that tomorrow's coh could be
% computed properly given how much bridge loan has to be taken on. This
% does not have to be too fine.
param_map('fl_coh_interp2nd_grid_gap') = 10;
