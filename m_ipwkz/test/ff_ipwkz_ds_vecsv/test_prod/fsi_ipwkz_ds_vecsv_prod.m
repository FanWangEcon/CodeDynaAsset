...
ar_fl_alpha = [0.30, 0.40, 0.50];
ar_fl_delta = [0.02, 0.07, 0.12];
it_z_n = 15;

%% Simulate Model with Discount = 0.87

for fl_delta = ar_fl_delta

    disp('xxxxxxxxxxxxxxxxxxxxxxxxxxx');
    disp('xxxxxxxxxxxxxxxxxxxxxxxxxxx');
    disp(['fl_alpha = ' num2str(ar_fl_alpha(1))]);
    disp(['fl_delta = ' num2str(fl_delta)]);
    disp('xxxxxxxxxxxxxxxxxxxxxxxxxxx');
    disp('xxxxxxxxxxxxxxxxxxxxxxxxxxx');
    disp('');
    disp('');
    ...
    % Call Default Parameters <https://fanwangecon.github.io/CodeDynaAsset/m_ipwkz/paramfunc/html/ffs_ipwkz_set_default_param.html ffs_ipwkz_set_default_param>
    ...
    param_map('fl_alpha') = ar_fl_alpha(1);
    ...
    % Call Grid Generator <https://fanwangecon.github.io/CodeDynaAsset/m_az/paramfunc/html/ffs_ipwkz_get_funcgrid.html ffs_ipwkz_get_funcgrid>
    [armt_map, func_map] = ffs_ipwkz_get_funcgrid(param_map, support_map, bl_input_override);

    % Call Dynamic Programming Problem <https://fanwangecon.github.io/CodeDynaAsset/m_az/solve/html/ff_ipwkz_vf_vecsv.html ff_ipwkz_vf_vecsv>
...
for fl_delta = ar_fl_delta
    ...
    disp('xxxxxxxxxxxxxxxxxxxxxxxxxxx');
    disp('xxxxxxxxxxxxxxxxxxxxxxxxxxx');
    disp(['fl_alpha = ' num2str(ar_fl_alpha(2))]);
    disp(['fl_delta = ' num2str(fl_delta)]);
    disp('xxxxxxxxxxxxxxxxxxxxxxxxxxx');
    disp('xxxxxxxxxxxxxxxxxxxxxxxxxxx');
    disp('');
    ...
    % Simulation Accuracy
    param_map('it_z_n') = it_z_n;
    param_map('fl_alpha') = ar_fl_alpha(2);
    param_map('fl_delta') = fl_delta;
...
for fl_delta = ar_fl_delta
    ...
    disp('xxxxxxxxxxxxxxxxxxxxxxxxxxx');
    disp('xxxxxxxxxxxxxxxxxxxxxxxxxxx');
    disp(['fl_alpha = ' num2str(ar_fl_alpha(3))]);
    disp(['fl_delta = ' num2str(fl_delta)]);
    disp('xxxxxxxxxxxxxxxxxxxxxxxxxxx');
    disp('xxxxxxxxxxxxxxxxxxxxxxxxxxx');
    disp('');
    ...
    % Simulation Accuracy
    param_map('it_z_n') = it_z_n;
    param_map('fl_alpha') = ar_fl_alpha(3);
    param_map('fl_delta') = fl_delta;
