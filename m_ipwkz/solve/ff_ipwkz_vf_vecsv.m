...
st_func_name = 'ff_ipwkz_vf_vecsv';
...
% armt_map
params_group = values(armt_map, {'ar_w_perc', 'ar_w_level', 'ar_z', 'ar_a_meshk', 'ar_k_mesha'});
[ar_w_perc, ar_w_level, ar_z, ar_a_meshk, ar_k_mesha] = params_group{:};
