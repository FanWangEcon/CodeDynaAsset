...
% ff_wkz_evf> for details about the second stage. See
% <https://fanwangecon.github.io/CodeDynaAsset/m_akz/solve/html/ff_iwkz_evf.html
% ff_iwkz_evf> for details about interpolation over u(c) and value(coh,z).
...
params_group = values(armt_map, {'ar_interp_c_grid', 'ar_interp_coh_grid', ...
    ...
    'ar_w_perc', 'mt_w_by_interp_coh_interp_grid'});
[ar_interp_c_grid, ar_interp_coh_grid, ...
    mt_interp_coh_grid_mesh_z, mt_z_mesh_coh_interp_grid, ...
    ar_w_perc, mt_w_by_interp_coh_interp_grid] = params_group{:};
