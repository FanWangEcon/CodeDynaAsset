...
% @seealso
%
% * _PREFERENCE_: savings only quick vs benchmark testing: <https://fanwangecon.github.io/CodeDynaAsset/m_az/test/ff_az_ds_vec/test_pref/html/fsi_az_ds_pref.html fsi_az_ds_pref>
% * _SHOCK_: savings only asset grid count testing: <https://fanwangecon.github.io/CodeDynaAsset/m_az/test/ff_az_ds_vec/test_shock/html/fsi_az_ds_shock.html fsi_az_ds_shock>
% * _PREFERENCE_: borr + save quick vs benchmark testing: <https://fanwangecon.github.io/CodeDynaAsset/m_abz/test/ff_az_ds_vec/test_pref/html/fsi_abz_ds_pref.html fsi_abz_ds_pref>
% * _SHOCK_: borr + save only asset grid count testing: <https://fanwangecon.github.io/CodeDynaAsset/m_abz/test/ff_az_ds_vec/test_shock/html/fsi_abz_ds_shock.html fsi_abz_ds_shock>
%
