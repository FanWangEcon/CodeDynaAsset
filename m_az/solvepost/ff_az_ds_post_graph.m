%% Graph Endogenous Distributions
% *back to <https://fanwangecon.github.io Fan>'s
% <https://fanwangecon.github.io/CodeDynaAsset/ Dynamic Assets Repository>
% Table of Content.*

%%
function ff_az_ds_post_graph(varargin)
%% FF_AZ_DS_POST_GRAPH genereate 4 graphs
% For each model outcome f(outcome), graph distribution. For outcomes in
% the same unit, graph distributions together, graph joint distributions of
% key outcomes. 
%
